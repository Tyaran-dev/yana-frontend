                    ...
                    <DatePicker
                        ...
                        renderCustomHeader={({
                            ...
                            <div className="flex justify-between items-center mb-3">
                                ...
                                <div
                                    className="bg-emerald-600 w-6 h-6 rounded-2xl flex items-center justify-center cursor-pointer"
                                    onClick={(e) => {
                                        e.stopPropagation();
                                ...
                                >
                                    {locale === "ar" ? <IoChevronBackSharp className="text-white rotate-180" /> : <IoChevronBackSharp className="text-white" />}
                                </div>
                                ...
                                >
                                    {locale === "ar" ? <IoChevronBackSharp className="text-white " /> : <IoChevronBackSharp className="text-white rotate-180" />}
                                </div>
                            </div>
                        )}
                    />
